        ...
        GeometryReader{ geometry in
            ZStack(alignment : .bottom){
                ...
                Circle()
                    ...
                    .offset(x : self.calcCircleBgPosition(tabIndex: self.tabIndex, geometry: geometry), y:UIApplication.shared.windows.first?
                    ...
                    HStack(spacing : 0){
                        ...
                        Button(action : {
                            ...
                            Image(systemName: "cart.fill")
                                ...
                                .foregroundColor(self.tabIndex == .cart ? self.changeIconColor(tabIndex: self.tabIndex) : Color.gray)                            .frame(width : geometry.size.width / 3, height: 50)
